        ...
        <div>
            ...
            <div className='max-w-4xl mx-auto bg-white border border-gray-200 rounded-2xl my-5 p-8'>
                ...
                <div className='flex justify-between mb-6'>
                    ...
                    <Button onClick={() => setOpen(true)} variant="outline" className="flex items-center gap-2 text-blue-500 border-blue-500 hover:bg-blue-100 transition-all">
                        <Pen /> Cập nhật
                    </Button>
                </div>
                ...
                <div className='my-6'>
                    ...
                    {
                        isResume ? (
                            <a target='blank' href={user?.profile?.resume} className='text-blue-600 hover:underline'>
